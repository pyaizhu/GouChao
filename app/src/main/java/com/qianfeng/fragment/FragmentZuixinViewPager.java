...
import com.qianfeng.adapter.MyHeadPicAdapter;
 ...
 * 主页最新的Fragment
 */
public class FragmentZuixinViewPager extends BasePagerFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_home_zuixin, container, false);
